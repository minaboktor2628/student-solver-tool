...
const allocationsRefInfo = [
  ...
  },
  {
    ...
    description:
      "Represents allocated student hours, including calculated values and margin of error.",
...
const assignmentsRefInfo = [
  ...
  },
  {
    jsonKey: "TAs",
    description:
      "List of Teaching Assistants assigned to the course section. Each entry contains their info and hours.",
    format:
      "Array of { First: String, Last: String, Locked: Boolean, Hours: Number }",
  ...
  },
  {
    jsonKey: "PLAs",
    description:
      "List of Peer Learning Assistants assigned to the course section. Each entry contains their info and hours.",
    format:
      "Array of { First: String, Last: String, Locked: Boolean, Hours: Number }",
    example: `[{"First": "Pedro", "Last": "Pascal", "Locked": false, "Hours": 10}]`,
    type: "Array",
  },
  {
    jsonKey: "GLAs",
    description:
      "List of Graduate Learning Assistants assigned to the course section. Each entry contains their info and hours.",
    format:
      "Array of { First: String, Last: String, Locked: Boolean, Hours: Number }",
    example: `[{"First": "Pedro", "Last": "Pascal", "Locked": false, "Hours": 10}]`,
    type: "Array",
...
const plaPrefRef = [
  ...
  },
  {
    jsonKey: "Class Name",
    description:
      "Each course code is listed as a key, with a Boolean indicating if the PLA is available for that course.",
  ...
  },
  {
    jsonKey: "Time Slot",
    description:
      "Each available time slot is listed as a key, with a Boolean indicating the PLAs availability.",
...
const taPrefRef = [
  ...
  },
  {
    jsonKey: "Class Name",
    description:
      "Each course code is listed as a key, with a Boolean indicating if the TA is available for that course.",
    format: "Course Code: Boolean",
    example: `"CS 1005": true`,
    type: "Object (keys as course codes, values as Boolean)",
  },
  {
    jsonKey: "Time Slot",
    description:
      "Each available time slot is listed as a key, with a Boolean indicating the TAs availability.",
    format: "Time Range: Boolean",
    example: `"T-F 3:00 PM - 4:50 PM": true`,
    type: "Object (keys as time ranges, values as Boolean)",
  },
