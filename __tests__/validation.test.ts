...
function createTestAssistantPreferences(overrides: Record<string, any> = {}): AssistantPreferences {
  const baseData = {
    First: 'John',
    Last: 'Doe', 
    Email: 'jdoe@wpi.edu',
...
function createTestAllocationWithoutAssistants(overrides: Record<string, any> = {}): AllocationWithoutAssistants {
  const baseData = {
...
describe('Validation Helper Functions', () => {
  ...
  describe('makeCourseToAssistantMap', () => {
    it('should map courses to qualified assistants', () => {
      const preferences: AssistantPreferences[] = [
        createTestAssistantPreferences({ 
          First: 'Alice', Last: 'Johnson', Email: 'ajohnson@wpi.edu',
          'CS 101': true, 'CS 202': false 
        }),
        createTestAssistantPreferences({ 
          First: 'Bob', Last: 'Smith', Email: 'bsmith@wpi.edu',
          'CS 101': true, 'CS 303': true 
        }),
        createTestAssistantPreferences({ 
          First: 'Carol', Last: 'Davis', Email: 'cdavis@wpi.edu',
          Available: false, 'CS 202': true 
        })
      ]
    ...
    it('should ignore non-course fields', () => {
      const preferences: AssistantPreferences[] = [
        createTestAssistantPreferences({ 
          First: 'Dave', Last: 'Wilson', Email: 'dwilson@wpi.edu',
          'CS 101': true,
    ...
    it('should only include courses that match CS pattern', () => {
      const preferences: AssistantPreferences[] = [
        createTestAssistantPreferences({
          First: 'Eve', Last: 'Brown', Email: 'ebrown@wpi.edu',
